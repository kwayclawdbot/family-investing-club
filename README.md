...
## Map (76 routes) — club-first · verified collective investing · belts
...
- `src/app/(app)` — tabbed shell: Home · Discover · **Club** · Learn · Profile (child accounts: Home · Learn · Practice · Family · Me)
  ...
  - Profile: belt-first identity + evidence layers, promotion ceremony, My Portfolio (private), brokerage connect (read-only, optional), privacy & sharing, settings, notifications, billing, referrals, help, badges, progress
  - Trust layer: club + FIC consensus on company pages, Verified Exposure view, Discover 'people like me' signals, leaderboards + XP board
