...
export type CompanyExtra = { sector: string; earnings?: string; circleId?: string; rank?: string; mix: { label: string; pct: number; color: string }[]; mixYear: string; understand: string[] };
export const companyExtras: Record<string, CompanyExtra> = {
  NVDA: { sector: "Semiconductors", earnings: "📊 earnings Wed · circle live", circleId: "nvda-earnings", rank: "#1 in semis", mixYear: "FY25", mix: [{ label: "Data center", pct: 78, color: "#4C8C4A" }, { label: "Gaming", pct: 9, color: "#E58234" }, { label: "Other", pct: 13, color: "#E9C46A" }], understand: ["Why did NVDA move today?", "How does Nvidia make money?", "Is NVDA expensive?", "What would $100 ten years ago be worth?"] },
