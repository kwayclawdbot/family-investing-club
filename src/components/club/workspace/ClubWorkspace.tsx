...
type Props = { club: Club; overview: ClubOverview; portfolio: PortfolioTab; members: MemberCard[]; exposure: VerifiedExposure; initialTab?: WorkspaceTab; forceNew?: boolean; chat?: ClubChatMessage[] | null; circles?: CircleView[] | null };
...
export function ClubWorkspace({ club, overview, portfolio, members, initialTab = "chat", forceNew, chat, circles }: Props) {
  ...
  return (
    <>
      ...
      {tab === "chat" && <ChatPane live={chat} circles={circles} proposal={overview.activeDecision ? { id: overview.activeDecision.proposalId, title: overview.activeDecision.title, hoursLeft: overview.activeDecision.hoursLeft, voted: overview.activeDecision.voted, eligible: overview.activeDecision.eligible } : null} />}
