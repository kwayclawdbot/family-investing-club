...
type Props = { club: Club; overview: ClubOverview; portfolio: PortfolioTab; members: MemberCard[]; exposure: VerifiedExposure; initialTab?: WorkspaceTab; forceNew?: boolean };
...
export function ClubWorkspace({ club, overview, portfolio, members, initialTab = "chat", forceNew }: Props) {
