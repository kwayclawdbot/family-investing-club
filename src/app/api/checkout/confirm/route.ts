...
import { bumpNeedsShipping } from "@/lib/server/shared/checkout-bumps";
import type { BumpChoice, CheckoutFlow } from "@/lib/server/shared/checkout-bumps";
...
export async function POST(req: NextRequest) {
  ...
  let vipOpen = false;
  try {
    vipOpen = flow === "vip" ? await vipGateOpen() : true;
  } catch (e) {
